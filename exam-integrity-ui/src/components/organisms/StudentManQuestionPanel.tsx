    ...
    <div className="flex items-start justify-between gap-3 mb-4">
      <div className="flex items-center gap-4 min-w-0">
        ...
        <div className="flex flex-col min-w-0">
          <span className="text-xs uppercase tracking-wide font-semibold text-slate-500">Question {questionNumber}</span>
          {(subject || gradeLevel) && (
        ...
        {options.map((opt) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className="text-sm leading-6 text-slate-900"><strong>{opt.key}.</strong>&nbsp;{opt.text}</span>
            </label>
          );
        })}
      </div>
