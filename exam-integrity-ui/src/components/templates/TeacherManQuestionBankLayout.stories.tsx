            ...
            sx={{
              ...
              ...(i === 0
                ? {
                    ...
                    '&:hover': { backgroundColor: colors.primary.fixedDim },
                  }
    ...
    <Box sx={{ display: 'flex', gap: 1 }}>
      {tags.map((tag) => (
        <Chip
          ...
          label={tag}
          size="small"
          style={{ backgroundColor: colors.surface.container.high, fontSize: '12px' }}
        />
      ))}
    </Box>
  </Box>
...
const sampleQuestions: QuestionCardProps[] = [
  {
    ...
    tags: ['algebra', 'grade10', 'functions'],
  },
  {
    type: 'MCQ',
    points: 3,
    uses: 88,
    text: 'Which of the following is NOT a prime number? A) 2  B) 17  C) 51  D) 97',
    tags: ['arithmetic', 'grade4', 'number-theory'],
  },
  {
    type: 'ESSAY_SHORT',
    points: 10,
    uses: 42,
    text: 'Explain the difference between mean, median, and mode with one example each.',
    tags: ['statistics', 'grade7'],
  },
];
