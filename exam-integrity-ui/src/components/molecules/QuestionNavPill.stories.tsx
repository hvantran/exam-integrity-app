...
import QuestionNavPill from './QuestionNavPill';

const meta: Meta<typeof QuestionNavPill> = {
  title: 'Molecules/QuestionNavPill',
  component: QuestionNavPill,
  tags: ['autodocs'],
  argTypes: {
    state: {
      control: 'select',
...
export default meta;
type Story = StoryObj<typeof QuestionNavPill>;
